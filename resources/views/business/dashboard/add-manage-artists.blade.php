        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card bg-white">
                <div class="card-header">Stylists
                    <span class="float-right"><a href="#" id="add_serive" class="btn btn-success">Add a Stylist</a></span>
                </div>
                        ...
                        <div class="form-row">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="gender_served" name="gender_served" required>
                        ...
                        <div class="form-row">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        {{-- <input class="custom-file-input rounded-0"> --}}
                                        <button type="submit" class="btn btn-success margin-top-33 btn-block">Save</button>
                                    </div>
                                </div>
                            </div>
