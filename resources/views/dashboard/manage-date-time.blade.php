                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            <form method="post" id="date-action-form">
                                                ...
                                                <input class="btn display-none btn-sm" id="enableDisableDateBtn"
                                                    type="submit" value="">
                                            </form>
                                            ...
                                            <div class="date-tab">
                                                @while ($start <= $end)
                                                    ...
                                                    @endif
                                                    <button
                                                        class="btn dateButton {{ in_array(date('d-m-Y', $start), $disabledDate) ? 'btn-disable-date-time' : '' }}"
                                                        {{ in_array($start, $disabledDate) ? 'disabled' : '' }}
                                                        value="{{ date('d-m-Y', $start) }}">{{ date('d', $start) }}
                                                    </button>
                                                    @php
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <form method="post" class="form-horizontal" id="manage-time-action-form">
                            ...
                            <input type="number" name="limit" class="form-control rounded-0" id="numberOfCustomer"
                                required min="1" placeholder="Number Of Customer" />
                            <input class="btn btn-outline-success rounded btn-sm my-2" id="manageDateTimeBtn" type="submit"
                                value="Save">
                        </form>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $.ajax({
            ...
            type: 'GET',
            data: {
                date: $('.date-tab button:nth-child(2)').val()
            },
