                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row gutters px-3 mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="actual_price" id="service_price" class="form-control rounded-0 number calculate_price" style="border:1px solid #65e717;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row gutters px-3 mb-2">
                                            ...
                                            <div class="col-sm-8">
                                            <input type="text" name="discount" placeholder="in %" id="discount" class="form-control number calculate_price"  style="border:1px solid #65e717;">
                                            </div>
                                        </div>
                                ...
                                <div class="card py-3">
                                    ...
                                    <input type="hidden" name="commission" id="commission" class="calculate_price form-control rounded-0 number" value="5" style="border:1px solid #65e717;">
