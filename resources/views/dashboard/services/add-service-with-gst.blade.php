	...
	<div class="row gutters">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
			...
			<div class="card bg-white">
				<div class="card-header">Add GST Services </div>
				<div class="card-body">
					<form class="form-signin-services small" method="post" id="form-signin" action="{{route('vendor.service.store')}}" >
						@csrf
						...
						<div class="form-row">
							...
							<div class="form-group col-md-4 package_section display-none">
								...
								<select name="service_type_name" id="service_type_name" class="form-control selectpicker" data-live-search="true">
									...
									@foreach($serviceType as $item)
										<option value="{{$item->service_type_name}}">{{$item->service_type_name}}</option>
									@endforeach
									@endif
								</select>
							</div>
							...
							<div class="form-group col-md-4 package_section display-none">
								...
								<input type="text"  alt="package_name" name="package_name" class="form-control rounded-0" placeholder="Package Name"/>
							</div>

							<div class="form-group col-md-4 package_section display-none">
								<label for="package_description" class="col-form-label">Package Description</label>
								<textarea name="package_description" placeholder="Package Description" id="package_description" style="height: 38px" class="form-control rounded-0" cols="30" rows="1"></textarea>
							</div>

							<div class="form-group col-md-4 service_section">
								<label for="inputEmail4" class="col-form-label">Select Service</label>
							...
							<div class="form-group col-md-4 service_section">
								...
								<input type="text" name="sub_service_name" class="rounded-0 custom-select form-control" id="text_sub_service_name" placeholder="Enter Sub Service" list="sub_service_name" />
							...
							<div class="form-group col-md-4">
								...
								<input type="text" id="duration" class="form-control rounded-0" name="duration" placeholder="Duration" required/>
							</div>
							<div class="form-group col-md-4">
						...
						<div class="col-md-12" style="margin:10px 0px; background:#f1f1f1; padding:10px 10px;"><strong>Pricing Panel GST Vendor</strong></div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-8">
													<input type="text" name="actual_price" id="service_price" class="form-control rounded-0 number calculate_price" style="border:1px solid #65e717;" required/>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-8">
												<input type="text" name="discount" id="discount" class="form-control number calculate_price" placeholder="in %" style="border:1px solid #65e717;">
												</div>
											</div>
											<div class="form-group row gutters px-3 mb-2">
												<label for="discount_valid" class="col-sm-4 col-form-label"><strong>Discount valid (days)</strong></label>
												<div class="col-sm-8">
												<input type="text" name="discount_valid" id="discount_valid" class="form-control number calculate_price" value="0" style="border:1px solid #65e717;">
												</div>
											</div>
											...
											<input type="hidden" min="5" max="100" name="commission" id="commission" class="form-control rounded-0 number calculate_price" value="5" style="border:1px solid #65e717;">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="actual_discount_amount" id="discount_amount" class="form-control number" value="0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="after_discount_price" id="after_discount_price" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="gst" id="gst" class="form-control rounded-0" readonly>
												</div>
											</div>
											<div class="form-group row gutters px-3 mb-2">
												<label for="pre_gst_amount" class="col-sm-6 col-form-label"><strong>Pre GST Amount</strong></label>
												<div class="col-sm-6">
												<input type="text" name="pre_gst_amount" id="pre_gst_amount" class="form-control rounded-0" readonly>
												</div>
											</div>
											<div class="form-group row gutters px-3 mb-2">
												<label for="list_price" class="col-sm-6 col-form-label"><strong>List Price</strong></label>
												<div class="col-sm-6">
												<input type="text" name="list_price" id="list_price" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="commission_amount" id="zoylee_commission_in_rs" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="gst_on_zoylee_commission" id="gst_on_zoylee_commission" class="form-control rounded-0" readonly>
												</div>
											</div>

											<div class="form-group row gutters px-3 mb-2">
												<label for="vendor_earning" class="col-sm-6 col-form-label"><strong>Total Collection</strong></label>
												<div class="col-sm-6">
												<input type="text" name="final_vendor_collection" id="final_vendor_collaction" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="vendor_earning" id="vendor_earning" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="internet_charge" id="internet_charge" class="form-control rounded-0" value="2" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="internet_charge_amount" id="internet_charge_in_rs" class="form-control rounded-0" readonly>
												</div>
											</div>
											...
											<div class="form-group row gutters px-3 mb-2">
												...
												<div class="col-sm-6">
												<input type="text" name="settlement_amount" id="settlement_amount" class="form-control rounded-0" style="color:green; font-weight:bold;" readonly>
												</div>
											</div>
											<input type="hidden" name="final_zoylee_income" id="final_zoylee_income" class="form-control rounded-0" style="color:green; font-weight:bold;" readonly>
											<input type="hidden" name="zoylee_net_income" id="zoylee_net_income" class="form-control rounded-0" style="color:green; font-weight:bold;" readonly>
											<input type="hidden" name="zoylee_user_discount" id="user_discount" class="form-control rounded-0" readonly>
...
<script>
    ...
    $('#service_price').keydown(function(e) {
