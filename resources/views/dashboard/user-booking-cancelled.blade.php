            ...
            <div class="main-content">
                <div class="row gutters text-center">
                    ...
                    <div class="col-md-4"><a href="?type=pending">
                            <h5 class="badge-pill badge-light py-2">Pending Booking &mdash; {{ $pendingBooking }}</h5>
                        </a></div>
                    <div class="col-md-4"><a href="?type=cancelled">
                            <h5 class="badge-pill badge-success py-2">
                                Cancelled Booking &mdash; {{ $canclledBooking ? $canclledBooking->total() : 0 }}</h5>
                        </a></div>
                </div>
                <!-- Row start -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                @if ($notifyBranchs && $notifyBranchs->count())
                                    <div class="bg-warning my-3 px-3 pt-3 pb-2 text-center rounded"
                                ...
                                @if ($canclledBooking)
                                    <div class="form-row">
                                        ...
                                        @foreach ($canclledBooking as $item)
                                            @if ($item->services)
                                                @php
                                                ...
                                                @endforeach
                                            @endif
                                            <div class="booking-list-cancelled">
                                                <a
                                                    href="{{ route('business.dashboard.user.booking.details', ['order_id' => $item->order_id, 'type' => 'Cancelled']) }}">
                                                    ...
                                                    <div class="float-right col-4">
                                                        <span
                                                            class="badge badge-bdr-pill badge-info">{{ $item->booking_date }}
                                                            <br />
