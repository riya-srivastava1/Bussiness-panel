        ...
        <div class="col-xl-12">
            <div class="card bg-white">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('vendor.add.branch.store') }}" method="post" id="form-signin"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label for="owner_contact" class="col-form-label">Primary Contact Number <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="owner_contact" minlength="10" maxlength="10" name="owner_contact"
                                    class="form-control number" value="{{ $data->owner_contact }}"
                                    placeholder="Owner/Manager's Mobile Number" required>
                                @error('owner_contact')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span><br>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="landline_number" minlength="10" maxlength="10"
                                    name="landline_number" value="{{ old('landline_number') }}" class="form-control number"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label for="confirm_password" class="col-form-label">Confirm Password <span
                                        class="text-danger">*</span> </label>
                                <input type="password" id="confirm_password" minlength="6" name="password_confirmation"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label for="notify_to" class="col-form-label">Notify to<span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input style="height: 80px" name="full_address" id="searchbox" class="form-control"
                                    placeholder="Full Address" value="{{ $data->vendor_profile->full_address ?? '' }}" />
                        ...
                        <div class="col-md-12 py-4">
                            ...
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Monday" name="days[]"
                                    value="Mon">
                                <label class="custom-control-label" for="Monday">Monday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Tuesday" name="days[]"
                                    value="Tue">
                                <label class="custom-control-label" for="Tuesday">Tuesday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Wednesday" name="days[]"
                                    value="Wed">
                                <label class="custom-control-label" for="Wednesday">Wednesday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Thursday" name="days[]"
                                    value="Thu">
                                <label class="custom-control-label" for="Thursday">Thursday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Friday" name="days[]"
                                    value="Fri">
                                <label class="custom-control-label" for="Friday">Friday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Saturday" name="days[]"
                                    value="Sat">
                                <label class="custom-control-label" for="Saturday">Saturday</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="Sunday" name="days[]"
                                    value="Sun">
