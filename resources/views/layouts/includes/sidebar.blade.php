        ...
        <div class="menu">
            ...
            <div class="menu-item {{ request()->routeIs('business.dashboard') ? 'active' : '' }}">
                <a href="{{ route('business.dashboard') }}" class="menu-link">
                    ...
                    <div class="menu-text">Business Dashboard</div>
                </a>
            </div>
            <div class="menu-item {{ request()->routeIs('dashboard.user.booking') ? 'active' : '' }}">
                <a href="{{ route('dashboard.user.booking') }}" class="menu-link">
                    <div class="menu-icon">
                        <i class="fas fa-dashboard"></i>
                    </div>
            ...
            <div
                class="menu-item has-sub {{ request()->routeIs('dashboard.myaccount') ? 'active' : '' }} {{ request()->routeIs('amenities') ? 'active' : '' }}">
                <a href="javascript:;" class="menu-link">
                    <div class="menu-icon">
                ...
                <div class="menu-submenu">
                    <div class="menu-item {{ request()->routeIs('dashboard.myaccount') ? 'active' : '' }}">
                        <a href="{{ route('dashboard.myaccount') }}" class="menu-link">
