    ...
    !(function (a) {
        ...
        function d(a, b, c, d) {
            for (
                ...
                if (
                    ...
                    (j = j.toUpperCase()),
                    (g =
                        "contains" === c ? j.indexOf(b) >= 0 : j.startsWith(b)))
                )
                    break;
            }
            return g;
        ...
        if ((h.classList.toggle("c3", !1), h.classList.contains("c3"))) {
            ...
            DOMTokenList.prototype.toggle = function (a, b) {
                return 1 in arguments && !this.contains(a) == !b
                    ? b
                    : i.call(this, a);
            };
        }
        ...
        var u = {
                ...
                BUTTONCLASS: "4" === t.major ? "btn-bs-select" : "btn-default",
                POPOVERHEADER:
                    "4" === t.major ? "popover-header" : "popover-title",
            },
        ...
        (x.VERSION = "1.13.0"),
            ...
            "4" === t.major &&
                ((x.DEFAULTS.style = "btn-bs-select"),
                (x.DEFAULTS.iconBase = ""),
            ...
            (x.prototype = {
                ...
                init: function () {
                    ...
                    this.$element.addClass("bs-select-hidden"),
                        ...
                        (this.$menu =
                            this.$newElement.children(".dropdown-menu")),
                ...
                setPositionData: function () {
                    ...
                    for (
                        var a = 0;
                        a < this.selectpicker.current.data.length;
                        a++
                    ) {
                        ...
                        "divider" === b.type
                            ? ((c = !1),
                              (b.height = this.sizeInfo.dividerHeight))
                            : "optgroup-label" === b.type
                            ? ((c = !1),
                              (b.height = this.sizeInfo.dropdownHeaderHeight))
                            ...
                            (b.position =
                                (0 === a
                                    ? 0
                                    : this.selectpicker.current.data[a - 1]
                                          .position) + b.height);
                    }
                },
                isVirtual: function () {
                    ...
                    function e(a, d) {
                        ...
                        (f.selectpicker.view.scrollTop = a),
                            !0 === t &&
                                ...
                                f.$menu[0].offsetWidth >
                                    f.sizeInfo.totalMenuWidth &&
                                ((f.sizeInfo.menuWidth =
                                    f.$menu[0].offsetWidth),
                                (f.sizeInfo.totalMenuWidth =
                                    f.sizeInfo.menuWidth +
                                    f.sizeInfo.scrollBarWidth),
                        ...
                        for (var u = 0; u < j; u++) {
                            ...
                            void 0 === r &&
                                a <=
                                    f.selectpicker.current.data[v - 1]
                                        .position -
                                        f.sizeInfo.menuInnerHeight &&
                                (r = u);
                        }
                            ...
                            void 0 !== f.activeIndex &&
                                ((h =
                                    f.selectpicker.current.elements[
                                        f.selectpicker.current.map.newIndex[
                                            f.prevActiveIndex
                                        ]
                                    ]),
                                (i =
                            ...
                            !0 === t &&
                                ...
                                (x =
                                    f.selectpicker.view.position1 > p - 1
                                        ? 0
                                        : f.selectpicker.current.data[p - 1]
                                              .position -
                                          f.selectpicker.current.data[
                        ...
                        if (
                            ...
                            if (c && d) {
                                ...
                                f.selectpicker.view.canHighlight[E] ||
                                    (E =
                                        1 +
                                        f.selectpicker.view.canHighlight
                                            .slice(1)
                                            .indexOf(!0)),
                                    (D =
                                        f.selectpicker.view.visibleElements[E]),
                                    ...
                                    D &&
                                        ...
                                        D.firstChild &&
                                            D.firstChild.classList.add(
                                                "active"
                                            )),
                                    (f.activeIndex =
                                        f.selectpicker.current.map.originalIndex[
                                            E
                                        ]);
                            }
                ...
                createLi: function () {
                    ...
                    var n = function (a, b, c, d) {
                        ...
                        r = function (a) {
                            var b,
                                ...
                                e = k.text.cloneNode(!1);
                            if (
                                ((e.textContent = a.labelEscaped), a.labelIcon)
                            ) {
                                var f = k.whitespace.cloneNode(!1);
                                (d = k.span.cloneNode(!1)),
                                    (d.className =
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (w) {
                            ...
                            v =
                                void 0 ===
                                    a(s.options[s.selectedIndex]).attr(
                                        "selected"
                                    ) &&
                            ...
                            if (F && !0 !== t.divider) {
                                if (c.options.hideDisabled && H) {
                                    if (void 0 === J.allOptionsDisabled) {
                                        ...
                                        D.data(
                                            "allOptionsDisabled",
                                            L.filter(":disabled").length ===
                                                L.length
                                        );
                                    }
                                    if (D.data("allOptionsDisabled"))
                                        return void j--;
                                }
                                var M = " " + E.className || "";
                ...
                render: function () {
                    ...
                    for (
                        ...
                        if (
                            ...
                            (c.push(h),
                            (d.length < 100 &&
                                "count" !== a.options.selectedTextFormat) ||
                                1 === c.length)
                        ) {
                            if (
                    ...
                    var m = this.multiple
                        ? d.join(this.options.multipleSeparator)
                        : d[0];
                    if (
                        (c.length > 50 && (m += "..."),
                        this.multiple &&
                        ...
                        if (
                            ...
                            var o =
                                this.selectpicker.view.availableOptionsCount;
                            m = (
                                "function" ==
                ...
                liHeight: function (b) {
                    if (b || (!1 !== this.options.size && !this.sizeInfo)) {
                        ...
                        var c = document.createElement("div"),
                            ...
                            m =
                                this.options.header &&
                                this.$menu.find("." + u.POPOVERHEADER).length >
                                    0
                                    ? this.$menu
                                          .find("." + u.POPOVERHEADER)[0]
                                          .cloneNode(!0)
                                    : null,
                        ...
                        var r,
                            ...
                            E = {
                                ...
                                horiz:
                                    e(
                                        B ? B.paddingLeft : D.css("paddingLeft")
                                    ) +
                                    e(
                                        B
                                            ? B.paddingRight
                            ...
                            F = {
                                ...
                                horiz:
                                    ...
                                    e(
                                        B ? B.marginRight : D.css("marginRight")
                                    ) +
                                    2,
                            };
                ...
                setMenuSize: function (a) {
                    ...
                    if (
                        (this.options.dropupAuto &&
                            ((h =
                                j * this.selectpicker.current.elements.length +
                                p.vert),
                        ...
                        for (var r = 0; r < this.options.size; r++)
                            "divider" ===
                                this.selectpicker.current.data[r].type && q++;
                                ...
                                f.is("body")
                                    ...
                                    : ((c = f.offset()),
                                      ...
                                      (c.left +=
                                          ...
                                          f.scrollLeft())),
                                (d = a.hasClass(u.DROPUP)
                                    ? 0
                                    : a[0].offsetHeight),
                                t.major < 4 &&
                                    ((g.top = b.top - c.top + d),
                                    (g.left = b.left - c.left)),
                ...
                setDisabled: function (a, b, c, d) {
                    ...
                    c || (c = this.selectpicker.main.map.newIndex[a]),
                        ...
                        e &&
                            ("4" === t.major &&
                                e.classList.toggle(u.DISABLED, b),
                ...
                clickListener: function () {
                    ...
                    d.data("spaceSelect", !1),
                        ...
                        this.$element.on("shown.bs.select", function () {
                            b.$menuInner[0].scrollTop !==
                                b.selectpicker.view.scrollTop &&
                                (b.$menuInner[0].scrollTop =
                                    b.selectpicker.view.scrollTop),
                    ...
                    this.$button.on("click.bs.dropdown.data-api", function () {
                        ...
                        this.$searchbox.on("input propertychange", function () {
                            ...
                            if (
                                ...
                                a._$lisSelected =
                                    a.$menuInner.find(".selected");
                                for (
                                    var e = 0;
                                    e < a.selectpicker.main.data.length;
                                    e++
                                ) {
                                ...
                                (a.activeIndex = void 0),
                                    ...
                                    f.length ||
                                        ...
                                        (b.innerHTML =
                                            a.options.noneResultsText.replace(
                                                "{0}",
                                                '"' + p(c) + '"'
                                            )),
                                        a.$menuInner[0].firstChild.appendChild(
                                            b
                                        ));
                ...
                val: function (a) {
                    return void 0 !== a
                        ? (this.$element.val(a).triggerNative("change"),
                          this.$element)
                        : this.$element.val();
                },
                    ...
                    if (
                        ...
                        (c =
                            !0 === q
                                ...
                                : k.selectpicker.current.map.newIndex[
                                      k.activeIndex
                                  ]),
                            void 0 === c && (c = -1),
                            -1 !== c &&
                            ...
                            b.which === s.ARROW_UP
                                ...
                                : (b.which === s.ARROW_DOWN || n) &&
                                  (c++,
                                  c + t >=
                                      k.selectpicker.view.canHighlight.length &&
                                      (c = 0),
                                  k.selectpicker.view.canHighlight[c + t] ||
                                      (c =
                                          c +
                        ...
                        b.which === s.ARROW_UP
                            ? 0 === t && c === l.length - 1
                                ? ((k.$menuInner[0].scrollTop =
                                      k.$menuInner[0].scrollHeight),
                                  (x =
                                      k.selectpicker.current.elements.length -
                                      1))
                            ...
                            (k.activeIndex =
                                k.selectpicker.current.map.originalIndex[x]),
                        ...
                        b.preventDefault(),
                            ...
                            k.selectpicker.keydown.resetKeyHistory.cancel &&
                                clearTimeout(
                                    k.selectpicker.keydown.resetKeyHistory
                                        .cancel
                                ),
                            (k.selectpicker.keydown.resetKeyHistory.cancel =
                        ...
                        for (
                            var B = 0;
                            B < k.selectpicker.current.data.length;
                            B++
                        ) {
                            var C,
